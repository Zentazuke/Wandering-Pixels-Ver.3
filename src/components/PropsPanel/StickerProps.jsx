...
const STICKER_COLORS = [
  null, // default (original colours)
  '#EF9F27','#E24B4A','#D85A30','#1D9E75','#7F77DD','#378ADD',
  '#2e2416','#ffffff','#b5943a','#39ff9f',
];

export default function StickerProps({ el }) {
    ...
    <div style={{ paddingBottom: 24 }}>
      ...
      <PropSection title="Colour" defaultOpen>
        <PropRow wrap>
          ...
          <input type="color" style={{ width: 22, height: 22, border: 'none', borderRadius: 3, padding: 0, cursor: 'pointer' }}
